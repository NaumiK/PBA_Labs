...
size_t MyString::size() const { return size_; }

const char *MyString::c_str() const { return buffer_; }
...
MyString::~MyString() { delete[] buffer_; }

std::ostream &operator<<(std::ostream &os, const MyString &string) {
  os << "size_: " << string.size_ << " capacity_: " << string.capacity_
...
const char *MyString::begin() { return buffer_; }

const char *MyString::end() { return buffer_ + size_; }

char MyString::operator[](size_t i) {
  if (i >= size_)
    throw std::out_of_range("MyStr");
  return buffer_[i];
}
